...
const prefix = "*";
client.on('ready', () => {
  client.user.setGame('ArabProMC | $help','https://www.twitch.tv/peery13');
  console.log('---------------');
...
client.on('message', message => {
    ...
    var omar;
      if(mentionned){
        ...
        .setFooter('ArabProMC',client.user.avatarURL) 
      message.channel.sendEmbed(embed);
    }
});
...
**__=== Team ArabProMC Support Team : Clyde ==__**
...
.then(co => {
  md = co.first().content
        co.first().delete()
        m.delete();
message.channel.send('**واخيرا وليس اخرا,قبل تقديم لدينا شرط الشرط هو انك ت موافق على شروط كلاها على الشرط اكتب حسنا واذا لم توافق على الشرط اكتب لا**').then(ms => {
...
var gg = message.guild.channels.find('name', '⫸【『apply-mod』】')
if(!gg) return;
if(gg) {
gg.send({embed : new Discord.RichEmbed()
.setDescription(`**  الرتبه :question:  : \n ${lan}\nlماذا سوف يفعل في الرتبه :link: :\n ${md} \nموافق على شروط :question: :\n ${br}  \nتم التقديم بواسطة  : <@${message.author.id}> **`)  
          .setFooter(`ArabProMC || Bot`)
.setTimestamp()
});
 }        
})
...
client.on("message", message => {
	...
	if(message.author.id !== '504707359751536640') return;
...
client.on('message',async message => {
  ...
  if (message.content.startsWith("$giveways")) {
    ...
    if (message.content.startsWith("$ban")) {
      if(!message.member.hasPermission('BAN_MEMBERS')) return message.reply(':warning: you dont have a Permission sory');
        ...
        member.ban().then((member) => {
            ...
            message.channel.send("**لا يمكنك تدر احد ادااره**");
        });
    }
});
...
client.on('message', message => {
    if(message.channel.type === 'dm') {
        var guildID = '447418160954474496'; // <=============== ايدي السيرفر حقك
        if(message.content.includes('discord.gg/')) {
            var member = client.guilds.find(g => g.id === guildID).members.find(m => m.id === message.author.id);
            member.ban({ reason: 'الاعلانات بالخاص' }).catch();
        }
    }
});
...
client.on("voiceStateUpdate", (old, new1) => {
    var channel = "503136275184877569";
    var role = "༺ voice  ༻"
...
function لول(o,n,channel,role){
    if (!o.voiceChannel && n.voiceChannel) {
        ...
        if (o.voiceChannelID == channel) {
            n.removeRole(n.guild.roles.find("name", role))//حقوق دايموند كودز
        }
    }
}
...
if (message.content.startsWith('$bcall')){
 if (message.author.id !== '504707359751536640') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '504707359751536640') return;
...
client.on('message', message => {
  ...
  const verifed = ["504707359751536640"];
...
client.on('guildCreate', guild => {
  client.channels.get("507627949852459008").send(`**تم اضافة البوت في سيرفر جديد مبروكك
